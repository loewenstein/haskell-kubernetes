...
type ApivApi = "api" :> "v1" :> Get '[JSON] () -- getAPIResources
    ...
    :<|> "api" :> "v1" :> "namespaces" :> Capture "namespace" Text :> "persistentvolumeclaims" :> Capture "name" Text :> QueryParam "pretty" Text :> ReqBody '[JSON] DeleteOptions :> Delete '[JSON] PersistentVolumeClaim -- deleteNamespacedPersistentVolumeClaim
    ...
    :<|> "api" :> "v1" :> "namespaces" :> Capture "namespace" Text :> "pods" :> Capture "name" Text :> QueryParam "pretty" Text :> ReqBody '[JSON] DeleteOptions :> Delete '[JSON] Pod -- deleteNamespacedPod
